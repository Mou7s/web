...
const cpus = [
  ...
  {
    Name: 'r5 5500',
    Architecture: 'Cezanne(Zen 2)',
    Cores: 6,
    Threads: 12,
    Overclock: 'Yes',
    L3Cache: '16 MB',
    Technology: '7 nm',
    Geekbench6Single: 1928,
  },
  {
    Name: 'snapdragon 845',
  ...
  },
  {
    ...
    L3Cache: '2 MB',
    Technology: '7 nm',
    Geekbench6Single: 885,
  },
  {
    Name: 'snapdragon 7+ gen 2',
    Architecture: 'Cortex-X2',
    Cores: 8,
    Threads: 8,
    Overclock: 'No',
    L3Cache: '2 MB',
    Technology: '4 nm',
    Geekbench6Single: 1496,
  },
  {
    Name: 'Helio X10',
